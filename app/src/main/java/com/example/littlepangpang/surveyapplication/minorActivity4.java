...
public class minorActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_minor4);
        ...
        Rbutton1 = (RadioButton) findViewById(R.id.radiobtn1minor4);
    ...
    public void button_click1(View view) {
        ...
        btn=(Button)findViewById(R.id.btnminor4);
        if(btn.getText()=="next") {
            startActivity(new Intent(this, minorActivity5.class));
        }
