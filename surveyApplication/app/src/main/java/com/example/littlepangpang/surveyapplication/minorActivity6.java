...
public class minorActivity6 extends AppCompatActivity {
    ...
    private RadioButton Rbutton5 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_minor6);
        ...
        Rbutton1 = (RadioButton) findViewById(R.id.radiobtn1minor6);
        Rbutton2 = (RadioButton) findViewById(R.id.radiobtn2minor6);
        Rbutton3 = (RadioButton) findViewById(R.id.radiobtn3minor6);
        Rbutton4 = (RadioButton) findViewById(R.id.radiobtn4minor6);
        Rbutton5 = (RadioButton) findViewById(R.id.radiobtn5minor6);
        btn = (Button) findViewById(R.id.btnminor6);
        //给RadioGroup设置事件监听
        genderGroup=(RadioGroup)findViewById(R.id.radiobtngroupminor6) ;
        genderGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radiogroup, int checkedId) {
                ...
                if (Rbutton5.isChecked() == true) {
                    ...
                    MainActivity.stringList[MainActivity.I] = Rbutton5.getText().toString();
                    MainActivity.I++;
                    btn.setText("next");
                }
    ...
    public void button_click1(View view) {
        ...
        btn=(Button)findViewById(R.id.btnminor6);
        if(btn.getText()=="next") {
            startActivity(new Intent(this, minorActivity7.class));
        }
