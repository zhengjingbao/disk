...
public class minorActivity10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_minor10);
        ...
        Rbutton1 = (RadioButton) findViewById(R.id.radiobtn1minor10);
        Rbutton2 = (RadioButton) findViewById(R.id.radiobtn2minor10);
        Rbutton3 = (RadioButton) findViewById(R.id.radiobtn3minor10);
        Rbutton4 = (RadioButton) findViewById(R.id.radiobtn4minor10);
        btn = (Button) findViewById(R.id.btnminor10);
    ...
    public void button_click1(View view) {
        ...
        btn=(Button)findViewById(R.id.btnminor10);
        if(btn.getText()=="next") {
            startActivity(new Intent(this, minorActivity11.class));
        }
