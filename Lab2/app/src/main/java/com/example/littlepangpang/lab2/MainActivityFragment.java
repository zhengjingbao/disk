package com.example.littlepangpang.lab2;

/**
 * Created by Little PangPang on 2017/3/16.
 */
...
public class MainActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        String[] forecastArray = {
            ...
            FetchMessageTask fetchmessageTask = new FetchMessageTask();
            fetchmessageTask.execute("http://mpianatra.com/Courses/files/data.json");
